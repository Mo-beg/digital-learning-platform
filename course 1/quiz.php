...
if (!$video_watched_check) {
    ...
    header("Location: /digital learning platform/course 1/material.php?msg=watch_video");
    exit;
}
// -- END VIDEO GUARD --------------------------------------------
...
<head>
    ...
    <title>Psychology Quiz - LearnHub</title>
...
<div class="quiz-container">
    ...
    <div class="quiz-header">
        <h1>The Psychology of Everyday Decisions - Quiz</h1>
        <p>Test your understanding of cognitive biases, habits, and emotional decision-making</p>
        <div class="quiz-info">
    ...
    <div class="start-screen" id="startScreen">
        ...
        <p>This quiz will help you assess your understanding of psychological patterns in decision-making. Read each question carefully and select the best answer.</p>
    ...
    <div class="result-screen" id="resultScreen">
        ...
        <div>
            ...
            <button class="btn-review" onclick="goToCourse()">
                <i class="fa-solid fa-book"></i><a href="/digital learning platform/course.php"> Back to Course</a>
            </button>
        </div>
    </div>
</div>
...
<script>
    ...
    const quizData = [
        {
            question: "Which bias occurs when you favor information that supports your existing beliefs?",
            options: ["Anchoring Bias", "Confirmation Bias", "Availability Bias", "Loss Aversion"],
            correct: 1
        },
        {
            question: "In a habit loop, what comes immediately after the cue?",
            options: ["Reward", "Motivation", "Routine", "Emotion"],
            correct: 2
        },
        {
            question: "Which factor most strongly influences impulse purchases?",
            options: ["Long-term planning", "Emotional state", "Mathematical reasoning", "Budget analysis"],
            correct: 1
        },
        {
            question: "Anchoring bias happens when:",
            options: [
                "You ignore emotions",
                "You rely too heavily on the first piece of information",
        ...
        {
            question: "Improving decision-making requires:",
            options: [
                "Ignoring emotions completely",
                "Being aware of biases",
                "Trusting first instincts always",
                "Avoiding all risks"
            ],
            correct: 1
        }
    ...
    function submitQuiz() {
        ...
        if (scorePercentage >= 60) {
            ...
            resultMessage.textContent = 'Great job! You understand how psychological patterns influence decisions.';
        } else {
            resultIcon.className = 'result-icon fail';
            resultIcon.innerHTML = '<i class="fa-solid fa-xmark-circle"></i>';
            resultTitle.textContent = 'Keep Learning!';
            resultMessage.textContent = 'Review the material and try again to strengthen your decision-making awareness.';
        }
