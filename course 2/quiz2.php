...
if (!$video_watched_check) {
    ...
    header("Location: /digital learning platform/course 2/material2.php?msg=watch_video");
    exit;
}
// -- END VIDEO GUARD --------------------------------------------
...
<head>
    ...
    <title>Financial Management Quiz - LearnHub</title>
...
<div class="quiz-container">
    ...
    <div class="quiz-header">
        <h1>Financial Management Fundamentals - Quiz</h1>
        <p>Test your understanding of budgeting, cash flow, investments, and risk management</p>
        <div class="quiz-info">
    ...
    <div class="start-screen" id="startScreen">
        <h2>Ready to Test Your Financial Knowledge?</h2>
        <p>This quiz will assess your understanding of financial management principles. Read each question carefully and select the best answer.</p>
...
<script>
    ...
    const quizData = [
        {
            ...
            options: ["Savings", "Needs", "Wants", "Investments"],
            correct: 1
        },
        {
        ...
        {
            question: "Higher expected return usually involves:",
            options: [
                "Lower risk",
                "Higher risk",
                "No uncertainty",
        ...
        {
            question: "Emergency funds should cover:",
            options: [
                "1 month",
                "2 months",
                "3-6 months",
    ...
    function submitQuiz() {
        ...
        if (scorePercentage >= 60) {
            ...
            resultMessage.textContent = 'Excellent. You understand financial fundamentals and risk control.';
        } else {
            resultIcon.className = 'result-icon fail';
            resultIcon.innerHTML = '<i class="fa-solid fa-xmark-circle"></i>';
            resultTitle.textContent = 'Keep Learning!';
            resultMessage.textContent = 'Review the material carefully and strengthen your financial base.';
        }
